...
func (r *NodeadmConfigReconciler) MachineToBootstrapMapFunc(_ context.Context, o client.Object) []ctrl.Request {
	...
	if m.Spec.Bootstrap.ConfigRef != nil && m.Spec.Bootstrap.ConfigRef.GroupVersionKind() == eksbootstrapv1.GroupVersion.WithKind(eksbootstrapv1.NodeadmConfigKind) {
...
func (r *NodeadmConfigReconciler) MachinePoolToBootstrapMapFunc(_ context.Context, o client.Object) []ctrl.Request {
	...
	if configRef != nil && configRef.GroupVersionKind() == eksbootstrapv1.GroupVersion.WithKind(eksbootstrapv1.NodeadmConfigKind) {
...
func (r *NodeadmConfigReconciler) ClusterToNodeadmConfigs(_ context.Context, o client.Object) []ctrl.Request {
	...
	for _, m := range machineList.Items {
		if m.Spec.Bootstrap.ConfigRef != nil &&
			m.Spec.Bootstrap.ConfigRef.GroupVersionKind() == eksbootstrapv1.GroupVersion.WithKind(eksbootstrapv1.NodeadmConfigKind) {
			name := client.ObjectKey{Namespace: m.Namespace, Name: m.Spec.Bootstrap.ConfigRef.Name}
			result = append(result, ctrl.Request{NamespacedName: name})
		}
	}
