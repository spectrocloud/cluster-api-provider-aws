...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*OIDCIdentityProviderConfig)(nil), (*v1alpha4.OIDCIdentityProviderConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha4.OIDCIdentityProviderConfig)(nil), (*OIDCIdentityProviderConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha3_OIDCIdentityProviderConfig_To_v1alpha4_OIDCIdentityProviderConfig(in *OIDCIdentityProviderConfig, out *v1alpha4.OIDCIdentityProviderConfig, s conversion.Scope) error {
	// WARNING: in.ClientId requires manual conversion: does not exist in peer-type
	...
	// WARNING: in.IssuerUrl requires manual conversion: does not exist in peer-type
