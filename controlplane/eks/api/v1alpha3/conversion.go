...
func (r *AWSManagedControlPlane) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst.Spec.OIDCIdentityProviderConfig.ClientID = restored.Spec.OIDCIdentityProviderConfig.ClientID
	dst.Spec.OIDCIdentityProviderConfig.IssuerURL = restored.Spec.OIDCIdentityProviderConfig.IssuerURL
