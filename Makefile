...
REGISTRY ?= gcr.io/spectro-common-dev/deepak/staging/cluster-api-aws
STAGING_REGISTRY := gcr.io/spectro-common-dev/deepak/staging/cluster-api-aws
PROD_REGISTRY ?= gcr.io/spectro-common-dev/deepak/prod/cluster-api-aws
